        ...
        <div class="flex gap-2 md:justify-between items-center">
          <div>
            ...
            <span class="flex items-center gap-2">
              ...
              <p class="text-sm text-slate-500">{{ books.length }} ta kitob</p>
            </span>
          </div>
                ...
                <div class="">
                  <div class="relative mx-auto">
                    <img
                      ...
                      class="w-full h-44 md:h-44 rounded object-cover"
                    />
                  </div>
                </div>
        ...
        <div class="flex gap-2 md:justify-between items-center">
          <div>
            ...
            <span class="flex items-center gap-2">
              ...
              <p class="text-sm text-slate-500">{{ audiobooks.length }} ta kitob</p>
            </span>
          </div>
          <span class="flex items-center justify-center cursor-pointer">
            <h1
...
function getDataGeneres(){
  axios.get(`/api/categories/${catalogID}/${subjectID}`)
   .then((response) => {
      products.value = response.data;
      audiobooks.value = response.data.filter((item) => item.tipe==='audio')
      books.value = response.data.filter((item) => item.tipe==='file')
...
const genres=ref([
   {
        id: 1,
        name: "Kitoblar",
        num:books.value.length
    },
    {
        id: 2,
        name: "Audio kitoblar",
        num:  audiobooks.value.length  
    },
])
